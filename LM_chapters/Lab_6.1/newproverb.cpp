...
// Fill in the prototype of the function writeProverb; this is to declare the
// function
...
//	          from the call. If that number is a 1 it prints "Now is the
// time 	          for all good men to come to the aid of their party."
// Otherwise, it prints
//"Now is the time for all good men 	          to come to the aid of their
// country." 	data
// in:  code for ending word of proverb (integer) 	data out: no actual
// parameter altered
//
//	*****************************************************************************
...
void writeProverb(int number) {
    ...
    /* Put "1" on the left side in case I had accidentally done = instead of ==
     * this way, I can ensure that there is no unwanted assigning happening
     */
    if (1 == number) {
